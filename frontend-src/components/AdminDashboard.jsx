...
const AdminDashboard = ({ user }) => {
  ...
  const definirGanhadorSala = async () => {
    ...
    try {
      ...
      const data = await res.json()
      if (res.ok) {
        setSuccess(`Ganhador definido! ${data.vencedor_nome} ganhou ${data.premio} pontos`)
  ...
  const definirGanhadorTorneio = async () => {
    ...
    try {
      ...
      const data = await res.json()
      if (res.ok) {
        setSuccess(`Torneio finalizado! Prêmio: ${data.premio} pontos`)
        ...
        <Tabs defaultValue="usuarios" className="w-full">
                ...
                {usuarios.map(u => (
                  <div key={u.id} className="flex justify-between items-center p-3 bg-gray-50 rounded">
                    <div>
                      ...
                      <Badge className="ml-2">{u.pontos} pts</Badge>
          ...
          <TabsContent value="salas" className="space-y-4">
            <Card className="p-4">
              ...
              <form onSubmit={criarSalaAdmin} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label>Valor Inicial (Pontos)</Label>
              ...
              <Card key={sala.id_sala} className="p-4">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Valor: {sala.valor_inicial} pts</p>
          ...
          <TabsContent value="torneios" className="space-y-4">
                <form onSubmit={criarTorneio} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 p-4 border rounded-lg bg-gray-50">            <div className="md:col-span-2">
                    ...
                    <Input value={novoTorneio.nome} onChange={e => setNovoTorneio({...novoTorneio, nome: e.target.value})} placeholder="Ex: Grande Copa Stake" required />
                  </div>
                  <div>
                ...
                {torneios.map(t => (
                  <Card key={t.id} className="p-4 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2 mt-1">
                      ...
                      {t.valor_inscricao > 0 && <Badge variant="secondary">Inscrição: {t.valor_inscricao} pts</Badge>}
                      {t.premio > 0 && <Badge variant="secondary">Prêmio: {t.premio} pts</Badge>}
            ...
            <Card className="p-4">
              ...
              <form onSubmit={cadastrarUsuario} className="space-y-3">
                ...
                <div>
                  ...
                  <Input type="number" value={novoUsuario.pontos} onChange={e => setNovoUsuario({...novoUsuario, pontos: e.target.value})} />
                </div>
                <div>
          ...
          <DialogContent>
            ...
            {torneioEditando && (
              <div className="space-y-4">
                ...
                <div>
                  <Label>Valor de Inscrição (pontos)</Label>
                  <Input 
                    type="number" 
        ...
        <Dialog open={dialogDefinirGanhadorSala} onOpenChange={setDialogDefinirGanhadorSala}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Sala: {salaParaDefinirGanhador?.nome_sala} - Prêmio: {salaParaDefinirGanhador?.valor_inicial} pts
              </DialogDescription>
            </DialogHeader>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                {torneioParaDefinirGanhador?.premio > 0 && ` - Prêmio: ${torneioParaDefinirGanhador.premio} pts`}
              </DialogDescription>
            </DialogHeader>
